import BookTypeFourDateBlock from '../models/bookTypeFourDate.js'

export const addBlockDates  = async(req, res, next) => {
    try {
        const blockDates = await BookTypeFourDateBlock.create(req.body)
...
export const getAllBlockDates = async (req, res, next) => {
    try {
        const blockDates = await BookTypeFourDateBlock.find()
...
export const deleteBlockedDate = async(req, res, next) => {
    try {
        const dates = await BookTypeFourDateBlock.findByIdAndDelete(req.params.id)
